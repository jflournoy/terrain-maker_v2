...
def main():
    ...
    parser.add_argument('--min-basin-depth', type=float, default=100.0,
                        help='Minimum basin depth (m) to preserve (legacy backend only, default: 100.0)')
    ...
    parser.add_argument('--max-breach-depth', type=float, default=50.0,
                        help='Max vertical breach per cell in meters (spec backend, default: 50.0)')
    parser.add_argument('--max-breach-length', type=int, default=100,
                        help='Max breach path length in cells (spec backend, default: 100)')
