...
from terrain_maker.terrain._terrain_color import TerrainColorMixin
from terrain_maker.terrain._terrain_mesh import TerrainMeshMixin
from terrain_maker.terrain._terrain_proximity import TerrainProximityMixin
from terrain_maker.terrain._terrain_water import TerrainWaterMixin
...
# e.g. `from terrain_maker.terrain.core import setup_camera`. Resolved lazily (PEP 562)
# so importing core doesn't load every submodule up front.
_REEXPORTS = {
    "clear_scene": "terrain_maker.terrain.scene_setup",
    "setup_camera": "terrain_maker.terrain.scene_setup",
    "setup_light": "terrain_maker.terrain.scene_setup",
    "setup_camera_and_light": "terrain_maker.terrain.scene_setup",
    "setup_two_point_lighting": "terrain_maker.terrain.scene_setup",
    "position_camera_relative": "terrain_maker.terrain.scene_setup",
    "setup_world_atmosphere": "terrain_maker.terrain.scene_setup",
    "setup_hdri_lighting": "terrain_maker.terrain.scene_setup",
    "setup_render_settings": "terrain_maker.terrain.rendering",
    "render_scene_to_file": "terrain_maker.terrain.rendering",
    "get_render_settings_report": "terrain_maker.terrain.rendering",
    "print_render_settings_report": "terrain_maker.terrain.rendering",
    "apply_colormap_material": "terrain_maker.terrain.materials",
    "apply_water_shader": "terrain_maker.terrain.materials",
    "create_background_plane": "terrain_maker.terrain.materials",
    "load_dem_files": "terrain_maker.terrain.data_loading",
    "load_filtered_hgt_files": "terrain_maker.terrain.data_loading",
    "reproject_raster": "terrain_maker.terrain.transforms",
    "smooth_raster": "terrain_maker.terrain.transforms",
    "flip_raster": "terrain_maker.terrain.transforms",
    "scale_elevation": "terrain_maker.terrain.transforms",
    "feature_preserving_smooth": "terrain_maker.terrain.transforms",
    "smooth_score_data": "terrain_maker.terrain.transforms",
    "slope_colormap": "terrain_maker.terrain.color_mapping",
    "elevation_colormap": "terrain_maker.terrain.color_mapping",
}
