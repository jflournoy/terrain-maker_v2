...
Example:
    from terrain_maker.terrain.visualization.flow_diagnostics import create_flow_diagnostics
...
import matplotlib
from terrain_maker.terrain.flow_accumulation import compute_flow_direction, compute_drainage_area
