...
The implementation lives in :mod:`terrain_maker.terrain.flow_accumulation`; this module
re-exports it so ``from terrain_maker.terrain.flow_pipeline import compute_flow_with_basins``
keeps working.
"""

from terrain_maker.terrain.flow_accumulation import compute_flow_with_basins
