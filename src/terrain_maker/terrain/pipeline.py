...
class TerrainPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        self.dem_dir = (
            Path(dem_dir)
            if dem_dir
            else Path(__file__).parents[3] / "data" / "dem" / "detroit"
        )
    ...
    def load_dem(self, pattern: str = "*.hgt") -> Tuple[np.ndarray, Affine]:
        ...
        # Load from source
        from terrain_maker.terrain.core import load_dem_files  # pylint: disable=import-outside-toplevel
    ...
    def apply_transforms(
        ...
        *,
        ...
        from terrain_maker.terrain.core import Terrain, reproject_raster, flip_raster, scale_elevation
    ...
    def detect_water(
        ...
        from terrain_maker.terrain.water import identify_water_by_slope  # pylint: disable=import-outside-toplevel
    ...
    def render_view(
        ...
        *,
        ...
        output_path = (
            Path(__file__).parents[3] / "examples" / f"detroit_elevation_{view}.png"
        )
