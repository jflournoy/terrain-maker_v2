...
from terrain_maker.scoring.combiner import ScoreComponent, ScoreCombiner
...
def compute_derived_inputs(
    ...
    """
    import numpy as np
    from terrain_maker.scoring.transforms import snow_consistency, terrain_consistency
